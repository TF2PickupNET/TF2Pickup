...
declare module 'react' {
  ...
  declare function createRef<ElementType: React$ElementType>(
  ...
  declare var Fragment: ({children: ?React$Node}) => React$Node;
  ...
  declare export function useState<T>(init: () => T): [T, (arg: T | (current: T) => T) => void];
  declare export function useState<T>(init: T): [T, (arg: T | (current: T) => T) => void];

  declare export function useEffect(
    cb: () => void | Promise<void> | null | () => void,
    inputs: $ReadOnlyArray<any>,
  ): void;

  declare export function useCallback<R, Callback: () => R>(
    cb: Callback,
    inputs: $ReadOnlyArray<any>,
  ): Callback;
  declare export function useCallback<Arg1, R, Callback: (arg1: Arg1) => R>(
    cb: Callback,
    inputs: $ReadOnlyArray<any>,
  ): Callback;
  declare export function useCallback<Arg1, Arg2, R, Callback: (arg1: Arg1, arg2: Arg2) => R>(
    cb: Callback,
    inputs: $ReadOnlyArray<any>,
  ): Callback;
  declare export function useCallback<Arg1, Arg2, Arg3, R, Callback: (arg1: Arg1, arg2: Arg2, arg3: Arg3) => R>(
    cb: Callback,
    inputs: $ReadOnlyArray<any>,
  ): Callback;

  declare export function useMemo<T>(create: () => T, inputs: $ReadOnlyArray<any>): T;
  declare export function useContext<T>(context: React$Context<T>): T;
  declare export function useRef<T>(init: T): {
    (value: T): void,
    current: T,
  };

  declare export function lazy<Props>(
    () => Promise<{ default: ComponentType<Props> }>,
  ): ComponentType<Props>;

  declare export var Suspense: ComponentType<{
    children: React$Node,
    fallback: React$Node,
  }>;

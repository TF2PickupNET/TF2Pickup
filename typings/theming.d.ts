declare module 'theming' {
  ...
  function createTheming<Theme>(context: React.Context<Theme>): Theming<Theme>;

  const withTheme: WithThemeFactory<DefaultTheme>;
  const ThemeProvider: ThemeProviderFactory<DefaultTheme>;
